    ...
    public void cadastrar(turma turma){
        ...
        try {
            if(!bd.getConnection()){
             ...
             statement.setInt(1, turma.getVagas_disponibilidadas());
             statement.setInt(1, turma.getVagas_ocupadas());
             statement.setString(1, turma.getDias());
             statement.setString(1, turma.getHorario());
